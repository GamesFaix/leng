...
import { AppSettings, AsyncRequestStatus } from "leng-core/src/logic/model";
...
async function downloadFileIfMissing(
  localPath: string,
  sourceUrl: string
): Promise<void> {
...
async function downloadSetSymbolIfMissing(
...
async function downloadCardImageIfMissing(
  settings: AppSettings,
  card: Card
): Promise<void> {
